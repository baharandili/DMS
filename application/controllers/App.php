...
class App extends CI_Controller {
	...
	public function index()
	{
        ...
        $cek = $this->db->query("SELECT Count(*) FROM document ")->result_array();
        $branch = $this->db->query("SELECT Count(*) FROM branch ")->result_array();
        $dpt = $this->db->query("SELECT Count(*) FROM department ")->result_array();
        $sct = $this->db->query("SELECT Count(*) FROM section ")->result_array();
        $cty = $this->db->query("SELECT Count(*) FROM category ")->result_array();
        $grp = $this->db->query("SELECT Count(*) FROM grp ")->result_array();
        $site = $this->db->query("SELECT Count(*) FROM sitelocation ")->result_array();
        $pic = $this->db->query("SELECT Count(*) FROM picemail ")->result_array();
		$data = array(
			'konten' => 'home',
            'judul' => 'Dashboard',
            'doc'=>$cek,
	...
	public function tambah_penjualan()
	{
		...
		$data = array(
			...
			'kodeurut' => $this->No_urut->buat_kode_dokumen(),
		);
		$this->load->view('v_index',$data);
	}

	public function hapus_branch($id_branch)
	{
		...
		<script type="text/javascript">
			...
			window.location='<?php echo base_url('app/branch') ?>';
		</script>
		<?php
	}
	...
	{
		return $this->db->table('id_branch')->countAll();
	}
}
