<div class="row" style="margin-bottom: 10px">
        ...
        <th>Action</th>
            ...
            <td style="text-align:center" width="200px">
                ...
                echo anchor(site_url('users/update/'.$users->id_user),'Update',array('class' => 'btn btn-warning btn-sm'));
                echo ' | '; 
                echo anchor(site_url('users/delete/'.$users->id_user),'Delete',array('class'=> 'btn btn-danger btn-sm'),' onclick=> "javasciprt: return confirm"(\'Are You Sure ?\')"');
                ?>
            </td>
        </tr>
                <?php
