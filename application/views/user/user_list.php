    ...
    <body>
        ...
        <th>Action</th>
            ...
            <td style="text-align:center" width="200px">
                <?php  
                echo anchor(site_url('user/update/'.$user->id_user),'Update',array('class' => 'btn btn-warning btn-sm'));
                echo ' | '; 
                echo anchor(site_url('user/delete/'.$user->id_user),'Delete',array('class'=> 'btn btn-danger btn-sm'),' onclick=> "javasciprt: return confirm"(\'Are You Sure ?\')"'); 
                ?>
            </td>
        </tr>
                <?php
